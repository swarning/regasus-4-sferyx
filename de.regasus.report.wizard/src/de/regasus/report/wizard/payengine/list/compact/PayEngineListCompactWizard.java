...
public class PayEngineListCompactWizard extends DefaultReportWizard implements IReportWizard {
	private PayEngineListReportParameter payEngineListReportParameter;

	public PayEngineListCompactWizard() {
		super();
	}
	...
	protected void doAddPages() {
		...
		addPage(new PayEngineListCompactOptionsWizardPage());
	}
