...
/**
 * A {@link SashForm} that forwards calls of {@link SashForm#setVisible(boolean)} to all of its children.
 * Use this {@link LazyableComposite} if one of its subordinated widgets is a {@link LazyComposite}
 * or {@link LazyHtmlEditor}.
 */
public class LazyableSashForm extends SashForm {

	public LazyableSashForm(Composite parent, int style) {
		super(parent, style);
	}
