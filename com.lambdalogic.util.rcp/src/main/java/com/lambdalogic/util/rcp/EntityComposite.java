...
/**
 * Base class for {@link Composite} implementations that refer to an entity.
 *
 ...
 * @param <EntityType>
 */
public abstract class EntityComposite<EntityType> extends Composite implements IModifiable {
	...
	public EntityComposite(Composite parent, int style, Object... initValues)
	throws Exception {
		super(parent, style);
