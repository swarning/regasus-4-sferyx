...
public class ProfileFileModel extends MICacheModel<Long, FileSummary> {

	private static ProfileFileModel singleton;


	private ProfileFileModel() {
		super();
	}


	public static ProfileFileModel getInstance() {
		if (singleton == null) {
			singleton = new ProfileFileModel();
		}
		return singleton;
	}
	...
	public FileSummary getProfileDocument(Long id) throws Exception {
	...
	public List<FileSummary> getProfileDocuments(List<Long> ids) throws Exception {
		return super.getEntities(ids);
	}


//	@Override
//	protected ProfileDocument createEntityOnServer(ProfileDocument profileDocument)
//	throws Exception {
//		profileDocument.validate();
//		profileDocument = getProfileDocumentMgr().create(profileDocument);
//		return profileDocument;
//	}
//
//
//	public ProfileDocument create(ProfileDocument profileDocument) throws Exception {
//		return super.create(profileDocument);
//	}
	...
	public void refreshByForeignKey(Long profileId) throws Exception {
		super.refreshEntitiesOfForeignKey(profileId);
	}
	...
	throws Exception {
		...
		List<FileSummary> fileSummaryList = getProfileMgr().readProfileFiles(profileId);
		return fileSummaryList;
	}


	public List<FileSummary> getProfileDocumentsByProfileId(Long profileId)
	throws Exception {
