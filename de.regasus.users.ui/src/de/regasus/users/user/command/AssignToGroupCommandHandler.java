...
public class AssignToGroupCommandHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			...
			String message = UsersI18N.SelectUserGroupForAssignment;

			String[] userGroupIDs = UsersAdministrationHelper.openGroupSelectionDialog(HandlerUtil.getActiveShell(event), title, message);
			UserAccountModel.getInstance().addGroupsToUserAccounts(userAccountList, userGroupIDs);
		}
		catch (Throwable e) {
