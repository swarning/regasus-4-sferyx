...
public class EditGlobalAdminConfigCommandHandler extends AbstractHandler {

	@Override
	public Object execute(ExecutionEvent event) throws ExecutionException {
		try {
			ConfigEditorInput input = ConfigEditorInput.getInstance(
				ConfigScope.GLOBAL_ADMIN, // RegasusConfigScope
				null // key
			);
