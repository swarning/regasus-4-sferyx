 ...
 */
public class EditEventAdminConfigHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (eventPK != null) {
			...
			ConfigEditorInput input = ConfigEditorInput.getInstance(ConfigScope.EVENT_ADMIN, eventPK.toString());
			try {
