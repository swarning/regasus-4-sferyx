...
/**
 * Handler for menu item "Create Group Manager...", which can be started via the "Veranstaltung" menu and the
 * "Veranstaltung" view.
 *
 * <p>
 ...
 */
public class CreateGroupManagerCommandHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		try {
			...
			if (eventPK != null) {
				...
				ParticipantEditorInput editorInput = ParticipantEditorInput.getCreateGroupManagerInstance(eventPK);
				try {
