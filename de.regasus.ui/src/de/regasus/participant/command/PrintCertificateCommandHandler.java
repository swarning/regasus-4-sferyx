...
public class PrintCertificateCommandHandler extends AbstractHandler {
					...
					if (editorSaveCheckOK) {
        				...
        				if (certificateDocumentList != null) {
        					for (DocumentContainer documentContainer : certificateDocumentList) {
        						/* save and print generated certificate file
        				...
        				String msg = I18N.PrintCertificateCommandHandler_FinalMessage;
