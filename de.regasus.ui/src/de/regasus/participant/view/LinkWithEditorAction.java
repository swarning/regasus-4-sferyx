/**
 * LinkWithEditorAction.java
 * created on 10.06.2013 17:17:01
 */
...
public class LinkWithEditorAction extends Action implements ActionFactory.IWorkbenchAction, IPartListener {

	public static final String ID = "de.regasus.event.action.LinkWithEditorAction";


	private final ParticipantTreeView participantTreeView;
	private final IWorkbenchWindow window;
	private IWorkbenchPart currentPart;


	public LinkWithEditorAction(ParticipantTreeView participantTreeView) {
		super(CoreI18N.LinkWithEditorAction_Text, AS_RADIO_BUTTON);
		this.participantTreeView = participantTreeView;
		this.window = participantTreeView.getSite().getWorkbenchWindow();
		setId(ID);
	...
	private void showInTree() {
		if (isChecked() && currentPart != null && currentPart instanceof IEditorPart) {
			...
			if (editorInput instanceof ILinkableEditorInput) {
				...
				participantTreeView.show(entityType, key);
			}
		}
	}
