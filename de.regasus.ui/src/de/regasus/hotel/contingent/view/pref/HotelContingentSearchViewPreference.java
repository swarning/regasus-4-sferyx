...
import static de.regasus.hotel.contingent.view.pref.HotelContingentSearchViewPreferenceDefinition.*;
...
public class HotelContingentSearchViewPreference extends AbstractPreference {

	private static final HotelContingentSearchViewPreference INSTANCE = new HotelContingentSearchViewPreference();
	...
	public static HotelContingentSearchViewPreference getInstance() {
		return INSTANCE;
	}


	private HotelContingentSearchViewPreference() {
	}
	...
	public void initialize() {
		PreferenceInitializerHelper.initializePreferences(getPreferenceStore(), HotelContingentSearchViewPreferenceDefinition.class);
	}
