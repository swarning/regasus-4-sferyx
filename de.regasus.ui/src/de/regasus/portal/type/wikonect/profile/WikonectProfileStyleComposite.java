...
import de.regasus.portal.type.wikonect.WikonectStyleColorComposite;
import de.regasus.portal.type.wikonect.WikonectStyleFontComposite;
import de.regasus.portal.type.wikonect.WikonectStyleSizeComposite;
import de.regasus.ui.Activator;



public class WikonectProfileStyleComposite extends Composite implements StyleParameterComposite {

	private static final String WIKONECT_PROFILE_LESS_RESOURCES_FILE_NAME = "wikonectprofile-less-resources.zip";
	...
	private WikonectStyleColorComposite colorComposite;
	private WikonectStyleFontComposite fontComposite;
	private WikonectStyleSizeComposite sizeComposite;
	...
	public WikonectProfileStyleComposite(Composite parent) {
	...
	public void createWidgets() throws Exception {
		...
		// Color Tab
		{
    		...
    		colorComposite = new WikonectStyleColorComposite(tabFolder);
		...
		// Font Tab
		{
			...
			fontComposite = new WikonectStyleFontComposite(tabFolder);
		...
		// Size Tab
		{
			...
			sizeComposite = new WikonectStyleSizeComposite(tabFolder);
...
//					directory = new File("/Users/sacha/tmp"); // comment-in for debug
		    		...
		    		if ( ! applicationLessFile.exists()) {
		    			throw new RuntimeException(WIKONECT_PROFILE_LESS_RESOURCES_FILE_NAME + " does not contain the expected file application.less.");
		    		}
...
//		}
	...
	private void copyLessResources(File dir) throws ClassNotFoundException, IOException {
		...
		if (styleTemplateClass != null) {
			InputStream inputStream = styleTemplateClass.getResourceAsStream(WIKONECT_PROFILE_LESS_RESOURCES_FILE_NAME);
			if (inputStream != null) {
