...
public class WikonectStyleColorComposite extends Composite {

	private static final String PRIMARY_COLOR_KEY = "color-primary";
	private static final RGB PRIMARY_COLOR_PROFILE_DEFAULT = new RGB(0x0d, 0x58, 0x77);

	private static final String PRIMARY_DARK_COLOR_KEY = "color-primary-dark";
	private static final RGB PRIMARY_DARK_COLOR_PROFILE_DEFAULT = new RGB(0x0a, 0x44, 0x5d);
	...
	private static final RGB ACCENT_COLOR_PROFILE_DEFAULT = new RGB(0xf4, 0x81, 0x21);
	...
	private static final RGB LINK_COLOR_PROFILE_DEFAULT = new RGB(0xf4, 0x81, 0x21);
	
	private static final String HEADER_COLOR_KEY = "color-header";
	private static final RGB HEADER_COLOR_PROFILE_DEFAULT = new RGB(0x0a, 0x44, 0x5d);
	...
	private static final RGB FOOTER_COLOR_PROFILE_DEFAULT = new RGB(0x0a, 0x44, 0x5d);
	...
	public WikonectStyleColorComposite(Composite parent) {
