package de.regasus.portal.type.wikonect;
...
public class WikonectStyleSizeComposite extends Composite {
	...
	private static final String PAGE_WRAPPER_WIDTH_DEFAULT = PAGE_WRAPPER_WIDTH_VALUE_WRAPPED;
	...
	private static final Integer FOOTER_HEIGHT_PROFILE_DEFAULT = 50; // px
	...
	private static final Integer NAVBAR_HEIGHT_PROFILE_DEFAULT = 56; // px
	...
	public WikonectStyleSizeComposite(Composite parent) {
	...
	public void createWidgets(Composite parent) {
		...
		// leftComposite
		{
    		...
    		// footer height
    		{
				...
				footerHeightSpinner.setStartValue( FOOTER_HEIGHT_PROFILE_DEFAULT.longValue() );
    			...
    			Button resetButton = new Button(composite, SWT.PUSH);
    			pushGridDataFactory.applyTo(resetButton);
    			resetButton.setText(FOOTER_HEIGHT_PROFILE_DEFAULT + "px");
    			resetButton.addSelectionListener( new SelectionAdapter() {
    				@Override
    				public void widgetSelected(SelectionEvent e) {
    					footerHeightSpinner.setValue(FOOTER_HEIGHT_PROFILE_DEFAULT);
    				}
    			} );
    		...
    		// navbar height
    		{
				...
				navbarHeightSpinner.setStartValue( NAVBAR_HEIGHT_PROFILE_DEFAULT.longValue() );
    			...
    			Button resetButton = new Button(composite, SWT.PUSH);
    			pushGridDataFactory.applyTo(resetButton);
    			resetButton.setText(NAVBAR_HEIGHT_PROFILE_DEFAULT + "px");
    			resetButton.addSelectionListener( new SelectionAdapter() {
    				@Override
    				public void widgetSelected(SelectionEvent e) {
    					navbarHeightSpinner.setValue(NAVBAR_HEIGHT_PROFILE_DEFAULT);
    				}
    			} );
				...
				public void run() {
					try {
...

						{
							...
							if (height == null) {
								height = FOOTER_HEIGHT_PROFILE_DEFAULT;
							}
...

						{
							...
							if (height == null) {
								height = NAVBAR_HEIGHT_PROFILE_DEFAULT;
							}
