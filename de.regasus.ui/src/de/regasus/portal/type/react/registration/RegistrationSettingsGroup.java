...
import de.regasus.portal.type.standard.registration.RegistrationSettingsGroupI18NWidgetController;
...
public class RegistrationSettingsGroup extends EntityGroup<ReactRegistrationPortalConfig> {
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		// Row 8
		{
    		...
    		label.setText( ReactRegistrationPortalConfig.PROFILE_PORTAL_URL.getString() );
