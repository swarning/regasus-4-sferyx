...
public class StandardGroupStyleColorComposite extends Composite {
	...
	private static final RGB PRIMARY_DARK_COLOR_STANDARD_DEFAULT = new RGB(0x17, 0x7b, 0x81);
	private static final RGB PRIMARY_DARK_COLOR_CLASSIC_DEFAULT = new RGB(0x1c, 0x88, 0xb9);
	...
	private static final RGB BACKGROUND_COLOR_STANDARD_DEFAULT = new RGB(0xff, 0xff, 0xff);
	...
	private static final RGB PAGE_BACKGROUND_COLOR_STANDARD_DEFAULT = new RGB(0xff, 0xff, 0xff);
	...
	private static final RGB ASIDE_COLOR_STANDARD_DEFAULT = new RGB(0xff, 0xff, 0xff);
	...
	private static final RGB HEADER_TEXT_COLOR_STANDARD_DEFAULT = new RGB(0xff, 0xff, 0xff);
	...
	private static final RGB FOOTER_COLOR_STANDARD_DEFAULT = new RGB(0x21, 0x9c, 0xa3);
	...
	private static final RGB FOOTER_TEXT_COLOR_STANDARD_DEFAULT = new RGB(0xff, 0xff, 0xff);
	...
	public StandardGroupStyleColorComposite(Composite parent) {
	...
	private boolean isStandard() {
		...
		try {
			if (pageLayout != null) {
				result = "standardgroup".equals(FileHelper.getNameWithoutExtension(pageLayout.getStyleTemplateFileName()));
			}
		} 
