...
public class StandardGroupStyleFontComposite extends Composite {

	private static final String FONT_SIZE_BASE_KEY = "font-size-base";
	private static final Integer FONT_SIZE_BASE_DEFAULT = 14; // px
	...
	private static final Integer INPUT_FONT_SIZE_DEFAULT = 14; // px
	...
	public StandardGroupStyleFontComposite(Composite parent) {
