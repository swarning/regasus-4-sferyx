...
public class CompanionSettingsGroup extends EntityGroup<StandardRegistrationPortalConfig> {
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		companionCountLabel.setText( StandardRegistrationPortalConfig.COMPANION_COUNT.getString() );
		...
		companionParticipantTypeEqualToMainParticipantButton.setText(StandardRegistrationPortalI18N.CompanionParticipantTypeEqualToMainParticipant);
		...
		companionDefaultParticipantTypeLabel.setText(StandardRegistrationPortalI18N.CompanionDefaultParticipantType);
		...
		companionWithProgrammeBookingsButton.setText( StandardRegistrationPortalConfig.COMPANION_SHOW_PROGRAMME_BOOKING_PAGE.getString() );
	...
	protected void syncWidgetsToEntity() throws Exception {
		...
		companionWithProgrammeBookingsButton.setSelection(
			entity.isCompanionShowProgrammeBookingPage()
		);
	...
	public void syncEntityToWidgets() {
		if (entity != null) {
			...
			entity.setCompanionShowProgrammeBookingPage(
