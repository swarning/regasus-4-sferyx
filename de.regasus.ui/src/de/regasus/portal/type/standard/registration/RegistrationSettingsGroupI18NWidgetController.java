...
public class RegistrationSettingsGroupI18NWidgetController implements I18NWidgetController<StandardRegistrationPortalConfig> {
	...
	public void createWidgets(Composite parent, ModifySupport modifySupport, String language) {
		...
		toProfileButtonLabelWidgetMap.put(language, builder.label(StandardRegistrationPortalConfig.TO_PROFILE_PORTAL_BUTTON_LABEL.getString()).build());
	}
