...
public class ParticipantTypeSettingsGroup extends EntityGroup<StandardHotelPortalConfig> {
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		defaultParticipantTypeLabel.setText(StandardHotelPortalI18N.DefaultParticipantType);
