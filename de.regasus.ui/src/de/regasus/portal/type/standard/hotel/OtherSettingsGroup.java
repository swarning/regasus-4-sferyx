...
//REFERENCE
public class OtherSettingsGroup extends EntityGroup<StandardHotelPortalConfig> {
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		// alternativeDomain
		{
    		...
    		label.setText( StandardHotelPortalConfig.ALTERNATIVE_DOMAIN.getString() );
    		label.setToolTipText( StandardHotelPortalConfig.ALTERNATIVE_DOMAIN.getDescription() );
		...
		// urlAfterLogout
		{
    		Label label = new Label(parent, SWT.NONE);
    		labelGridDataFactory.applyTo(label);
    		label.setText( StandardHotelPortalConfig.URL_AFTER_LOGOUT.getString() );
    		label.setToolTipText( StandardHotelPortalConfig.URL_AFTER_LOGOUT.getDescription() );
		...
		{
			createTopLabel(parent, StandardHotelPortalConfig.GOOGLE_TAG_MANAGER_HEAD.getString());
		...
		{
			createTopLabel(parent, StandardHotelPortalConfig.GOOGLE_TAG_MANAGER_BODY.getString());
