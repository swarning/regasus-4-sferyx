...
public class PaymentI18NWidgetController implements I18NWidgetController<PaymentWithFeeComponent>{

	// the entity
	private PaymentWithFeeComponent component;
	...
	public void createWidgets(Composite parent, ModifySupport modifySupport, String lang) {
		...
		buttonLabelWidgetMap.put(lang, builder.fieldMetadata(PaymentWithFeeComponent.ONLINE_PAYMENT_BUTTON_LABEL).build());
	...
	@Override
	public void setEntity(PaymentWithFeeComponent component) {
	...
	private void syncWidgetsToEntity() {
		if (component != null) {
			SWTHelper.syncExecDisplayThread(new Runnable() {
				...
				public void run() {
					try {
						setLanguageStringToTextWidget(component.getOnlinePaymentButtonLabel(), buttonLabelWidgetMap);
	...
	public void syncEntityToWidgets() {
		if (component != null) {
			component.setOnlinePaymentButtonLabel( buildLanguageString(buttonLabelWidgetMap) );
