...
public class PortalTableComponentLabelsComposite extends EntityComposite<PortalTableComponent> {
	...
	private I18NComposite<PortalTableComponent> i18nComposite;
	...
	public PortalTableComponentLabelsComposite(Composite parent, int style, Long portalPK)
	throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		descriptionLabel.setText(I18N.PortalTableComponentComposite_RenameLabelsDescription);

		i18nComposite = new I18NComposite<>(parent, SWT.BORDER, languageList, new PortalTableComponentLabelsI18NWidgetController());
