...
public class TotalAmountComponentComposite extends EntityComposite<TotalAmountComponent> {
	...
	private I18NComposite<TotalAmountComponent> i18nComposite;
	...
	public TotalAmountComponentComposite(Composite parent, int style, Long portalPK) throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.TotalAmountComponent.getString() );
		if (expertMode) {
	...
	public void buildCurrency(Composite parent) throws Exception {
   		SWTHelper.createLabel(parent, TotalAmountComponent.CURRENCY.getString(), true);
	...
	private void buildLabel(Composite parent) {
		...
		i18nComposite = new I18NComposite(parent, SWT.BORDER, languageList, new TotalAmountComponentCompositeI18NWidgetController());
