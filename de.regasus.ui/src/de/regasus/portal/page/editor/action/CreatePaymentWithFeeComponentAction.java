...
public class CreatePaymentWithFeeComponentAction extends AbstractCreateComponentAction {

	private static final String ID = MethodHandles.lookup().lookupClass().getName();
	private static final String TEXT = I18N.PageEditor_CreatePaymentWithFeeComponent;


	public CreatePaymentWithFeeComponentAction(PageContentTreeComposite pageContentTreeComposite) {
	...
	protected Component buildComponent() {
		PaymentWithFeeComponent component = PaymentWithFeeComponent.build( getLanguageList() );
