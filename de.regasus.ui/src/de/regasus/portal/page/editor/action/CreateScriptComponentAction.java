...
public class CreateScriptComponentAction extends AbstractCreateComponentAction {

	private static final String ID = MethodHandles.lookup().lookupClass().getName();
	private static final String TEXT = I18N.PageEditor_CreateScriptComponent;


	public CreateScriptComponentAction(PageContentTreeComposite pageContentTreeComposite) {
	...
	protected Component buildComponent() {
		ScriptComponent component = ScriptComponent.build();
		return component;
	}
