...
public class ManageAbstractSubmissionComponentComposite extends EntityComposite<ManageAbstractSubmissionComponent> {
	...
	private I18NComposite<ManageAbstractSubmissionComponent> i18nComposite;
	...
	public ManageAbstractSubmissionComponentComposite(Composite parent, int style, Long portalPK) throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.ManageAbstractSubmissionComponent.getString() );
		if (expertMode) {
	...
	private void buildWebServiceUrlText(Composite parent) throws Exception {
   		SWTHelper.createLabel(parent, ManageAbstractSubmissionComponent.WEB_SERVICE_URL.getString());
	...
	private void buildSubmissionUrlText(Composite parent) throws Exception {
   		SWTHelper.createLabel(parent, ManageAbstractSubmissionComponent.SUBMISSION_URL.getString());
	...
	private void buildI18NComposite(Composite parent) {
		i18nComposite = new I18NComposite<>(
			...
			SWT.BORDER,
			languageList,
			new ManageAbstractSubmissionComponentCompositeI18NWidgetController()
		);
