...
public class ManageAbstractTableComponentComposite extends EntityComposite<ManageAbstractTableComponent> {
	...
	private I18NComposite<ManageAbstractTableComponent> i18nComposite;
	...
	public ManageAbstractTableComponentComposite(Composite parent, int style, Long portalPK) throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.ManageAbstractTableComponent.getString() );
		if (expertMode) {
	...
	private void buildI18NComposite(Composite parent) {
		i18nComposite = new I18NComposite<>(
			...
			SWT.BORDER,
			languageList,
			new ManageAbstractTableComponentCompositeI18NWidgetController()
		);
