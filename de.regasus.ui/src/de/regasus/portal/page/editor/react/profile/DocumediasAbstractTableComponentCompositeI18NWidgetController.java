...
public class DocumediasAbstractTableComponentCompositeI18NWidgetController
	implements I18NWidgetController<DocumediasAbstractTableComponent> {

	// the entity
	private DocumediasAbstractTableComponent component;
	...
	public void createWidgets(Composite parent, ModifySupport modifySupport, String lang) {
		...
		abstractNumberColumnNameWidgetMap.put(lang, builder.fieldMetadata(DocumediasAbstractTableComponent.ABSTRACT_NUMBER_COLUMN_NAME).build());
		abstractTitleColumnNameWidgetMap.put(lang, builder.fieldMetadata(DocumediasAbstractTableComponent.ABSTRACT_TITLE_COLUMN_NAME).build());
		abstractStatusColumnNameWidgetMap.put(lang, builder.fieldMetadata(DocumediasAbstractTableComponent.ABSTRACT_STATUS_COLUMN_NAME).build());
	}
	...
	@Override
	public DocumediasAbstractTableComponent getEntity() {
		return component;
	}


	@Override
	public void setEntity(DocumediasAbstractTableComponent component) {
