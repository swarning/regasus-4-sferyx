...
public class ManageAbstractPaymentComponentComposite extends EntityComposite<ManageAbstractPaymentComponent> {
	...
	public ManageAbstractPaymentComponentComposite(Composite parent, int style, Long portalPK) throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.ManageAbstractPaymentComponent.getString() );
		if (expertMode) {
	...
	private void buildWebhookUrlText(Composite parent) throws Exception {
   		SWTHelper.createLabel(parent, ManageAbstractPaymentComponent.WEBHOOK_URL);
	...
	private void buildParticipantTypeCombo(Composite parent) throws Exception {
		SWTHelper.createLabel(parent, ManageAbstractPaymentComponent.PARTICIPANT_TYPE_ID);
	...
	private void buildProgrammePointCombo(Composite parent) throws Exception {
		SWTHelper.createLabel(parent, ManageAbstractPaymentComponent.PROGRAMME_POINT_ID);
