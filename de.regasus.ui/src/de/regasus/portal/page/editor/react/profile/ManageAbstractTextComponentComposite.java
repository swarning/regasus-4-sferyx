...
public class ManageAbstractTextComponentComposite extends EntityComposite<ManageAbstractTextComponent> {
	...
	public ManageAbstractTextComponentComposite(Composite parent, int style, Long portalPK)
	throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.ManageAbstractTextComponent.getString() );
		...
		submissionNotAvailableWidget = 	buildEditor(ManageAbstractTextComponent.SUBMISSION_NOT_AVAILABLE_TEXT);
		noAbstractWidget             =	buildEditor(ManageAbstractTextComponent.NO_ABSTRACT_TEXT);
		abstractSubmittedWidget      =	buildEditor(ManageAbstractTextComponent.ABSTRACT_SUBMITTED_TEXT);
	}
