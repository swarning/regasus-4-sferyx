...
public class SendRegistrationConfirmationComponentCompositeI18NWidgetController
	implements I18NWidgetController<SendRegistrationConfirmationComponent> {

	// the entity
	private SendRegistrationConfirmationComponent component;
	...
	public void createWidgets(Composite parent, ModifySupport modifySupport, String lang) {
		...
		buttonLabelWidgetMap.put(lang, builder.fieldMetadata(SendRegistrationConfirmationComponent.BUTTON_LABEL).build());
	}
	...
	@Override
	public SendRegistrationConfirmationComponent getEntity() {
		return component;
	}


	@Override
	public void setEntity(SendRegistrationConfirmationComponent component) {
