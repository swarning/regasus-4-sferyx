...
public class SendRegistrationConfirmationComponentComposite extends EntityComposite<SendRegistrationConfirmationComponent> {
	...
	private I18NComposite<SendRegistrationConfirmationComponent> i18nComposite;
	...
	public SendRegistrationConfirmationComponentComposite(Composite parent, int style, Long portalPK)
	throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.SendRegistrationConfirmationComponent.getString() );
	...
	private void buildI18NComposite(Composite parent) {
		i18nComposite = new I18NComposite<>(
			...
			SWT.BORDER,
			languageList,
			new SendRegistrationConfirmationComponentCompositeI18NWidgetController()
		);
