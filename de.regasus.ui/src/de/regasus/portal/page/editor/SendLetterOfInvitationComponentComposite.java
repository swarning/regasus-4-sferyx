...
public class SendLetterOfInvitationComponentComposite extends EntityComposite<SendLetterOfInvitationComponent> {
	...
	private I18NComposite<SendLetterOfInvitationComponent> i18nComposite;
	...
	public SendLetterOfInvitationComponentComposite(Composite parent, int style, Long portalPK)
	throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.SendLetterOfInvitationComponent.getString() );
	...
	private void buildI18NComposite(Composite parent) {
		i18nComposite = new I18NComposite<>(
			...
			SWT.BORDER,
			languageList,
			new SendLetterOfInvitationComponentCompositeI18NWidgetController()
		);
