...
public class HotelDetailsComponentComposite extends EntityComposite<HotelDetailsComponent> {
	...
	private Button hideTravelTypeButton;

	private I18NComposite<HotelDetailsComponent> i18nComposite;
	...
	public HotelDetailsComponentComposite(Composite parent, int style, Long portalPK) throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.HotelDetailsComponent.getString() );
		if (expertMode) {
	...
	private void buildButton() {
		...
		hideTravelTypeButton = new Button(this, SWT.CHECK);
		hideTravelTypeButton.setText( HotelDetailsComponent.HIDE_TRAVEL_TYPE.getLabel() );
		hideTravelTypeButton.setToolTipText( HotelDetailsComponent.HIDE_TRAVEL_TYPE.getDescription() );
		hideTravelTypeButton.addSelectionListener(modifySupport);
		GridDataFactory.fillDefaults().span(COL_COUNT - 1, 1).applyTo(hideTravelTypeButton);
	}
	...
	private void buildLabel(Composite parent) {
		...
		i18nComposite = new I18NComposite(parent, SWT.BORDER, languageList, new HotelDetailsComponentCompositeI18NWidgetController());
	...
	protected void syncWidgetsToEntity() {
		...
		hideTravelTypeButton.setSelection(entity.isHideTravelType());
	...
	public void syncEntityToWidgets() {
		if (entity != null) {
			...
			entity.setHideTravelType( hideTravelTypeButton.getSelection() );
