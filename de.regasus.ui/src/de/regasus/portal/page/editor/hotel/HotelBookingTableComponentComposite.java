...
public class HotelBookingTableComponentComposite extends EntityComposite<HotelBookingTableComponent> {
	...
	private HotelBookingTableComponentGeneralComposite generalComposite;
	private HotelBookingTableComponentAvailableItemsComposite availableItemsComposite;
	private HotelBookingTableComponentLabelsComposite columnNameComposite;
	...
	public HotelBookingTableComponentComposite(Composite parent, int style, Long portalPK)
	throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.HotelBookingTableComponent.getString() );
		...
		// General Tab
		{
    		...
    		generalComposite = new HotelBookingTableComponentGeneralComposite(tabFolder, SWT.NONE, portal.getId());
		...
		// Available Items Tab
		{
			...
			availableItemsComposite = new HotelBookingTableComponentAvailableItemsComposite(tabFolder, SWT.NONE);
		...
		// Labels Tab
		{
			...
			columnNameComposite = new HotelBookingTableComponentLabelsComposite(tabFolder, SWT.NONE, portal.getId());
