...
public class HotelBookingTableComponentLabelsComposite extends EntityComposite<HotelBookingTableComponent> {
	...
	private I18NComposite<HotelBookingTableComponent> i18nComposite;
	...
	public HotelBookingTableComponentLabelsComposite(Composite parent, int style, Long portalPK)
	throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		i18nComposite = new I18NComposite<>(parent, SWT.BORDER, languageList, new HotelBookingTableComponentLabelsI18NWidgetController());
