...
public class HotelSearchFilterComponentComposite extends EntityComposite<HotelSearchFilterComponent> {
	...
	private I18NComposite<HotelSearchFilterComponent> i18nComposite;
	...
	public HotelSearchFilterComponentComposite(Composite parent, int style, Long portalPK) throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.HotelSearchFilterComponent.getString() );
		if (expertMode) {
	...
	private void buildLabel(Composite parent) {
		...
		i18nComposite = new I18NComposite(parent, SWT.BORDER, languageList, new HotelSearchFilterComponentCompositeI18NWidgetController());
