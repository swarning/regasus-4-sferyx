...
public class HotelSearchResultComponentComposite extends EntityComposite<HotelSearchResultComponent> {
	...
	private I18NComposite<HotelSearchResultComponent> i18nComposite;
	...
	public HotelSearchResultComponentComposite(Composite parent, int style, Long portalPK) throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.HotelSearchResultComponent.getString() );
		if (expertMode) {
	...
	private void buildLabel(Composite parent) {
		...
		i18nComposite = new I18NComposite(parent, SWT.BORDER, languageList, new HotelSearchResultComponentCompositeI18NWidgetController());
