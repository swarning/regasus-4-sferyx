...
public class EditBookingComponentComposite extends EntityComposite<EditBookingComponent> {
	...
	private I18NComposite<EditBookingComponent> i18nComposite;
	...
	public EditBookingComponentComposite(Composite parent, int style, Long portalPK) throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.EditBookingComponent.getString() );
		if (expertMode) {
	...
	private void buildLabel(Composite parent) {
		...
		i18nComposite = new I18NComposite(parent, SWT.BORDER, languageList, new EditBookingComponentCompositeI18NWidgetController());
