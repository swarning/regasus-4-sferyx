...
public class HotelTotalAmountComponentComposite extends EntityComposite<HotelTotalAmountComponent> {
	...
	private I18NComposite<HotelTotalAmountComponent> i18nComposite;
	...
	public HotelTotalAmountComponentComposite(Composite parent, int style, Long portalPK) throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.HotelTotalAmountComponent.getString() );
		if (expertMode) {
	...
	public void buildCurrency(Composite parent) throws Exception {
   		SWTHelper.createLabel(parent, HotelTotalAmountComponent.CURRENCY.getString(), true);
	...
	private void buildLabel(Composite parent) {
		...
		i18nComposite = new I18NComposite(parent, SWT.BORDER, languageList, new HotelTotalAmountComponentCompositeI18NWidgetController());
