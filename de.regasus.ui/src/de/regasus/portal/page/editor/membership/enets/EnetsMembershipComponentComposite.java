...
public class EnetsMembershipComponentComposite extends EntityComposite<EnetsMembershipComponent> {
	...
	private I18NComposite<EnetsMembershipComponent> i18nComposite;
	...
	public EnetsMembershipComponentComposite(Composite parent, int style, Long portalPK)
	throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.EnetsMembershipComponent.getString() );
	...
	private void buildI18NWidgets(Composite parent) {
		i18nComposite = new I18NComposite<>(parent, SWT.BORDER, languageList, new EnetsMembershipI18NWidgetController());
