...
public class NeurosciencesMembershipComponentComposite extends EntityComposite<NeurosciencesMembershipComponent> {
	...
	private I18NComposite<NeurosciencesMembershipComponent> i18nComposite;
	...
	public NeurosciencesMembershipComponentComposite(Composite parent, int style, Long portalPK)
	throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.NeurosciencesMembershipComponent.getString() );
	...
	private void buildI18NWidgets(Composite parent) {
		i18nComposite = new I18NComposite<>(parent, SWT.BORDER, languageList, new NeurosciencesMembershipI18NWidgetController());
	...
	private void buildNonMemberHint(Composite parent) {
		...
		label.setText( NeurosciencesMembershipComponent.NON_MEMBER_HINT.getString() );
	...
	private void buildUnconfimedMembershipMessage(Composite parent) {
		Label label = new Label(parent, SWT.RIGHT);
		GridDataFactory.swtDefaults().align(SWT.LEFT, SWT.CENTER).span(COL_COUNT, 1).indent(SWT.DEFAULT, 10).applyTo(label);
		label.setText( NeurosciencesMembershipComponent.UNCONFIRMED_MEMBERSHIP_MESSAGE.getString() );
		SWTHelper.makeBold(label);
