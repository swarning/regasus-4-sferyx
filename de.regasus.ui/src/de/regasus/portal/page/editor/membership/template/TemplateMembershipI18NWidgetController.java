...
public class TemplateMembershipI18NWidgetController implements I18NWidgetController<TemplateMembershipComponent>{


	// the entity
	private TemplateMembershipComponent membershipComponent;
	...
	public TemplateMembershipI18NWidgetController() {
	}
	...
	public void createWidgets(Composite parent, ModifySupport modifySupport, String lang) {
		...
		membershipLabelWidgetMap.put(
			lang, 
			builder
				.fieldMetadata(TemplateMembershipComponent.MEMBERSHIP_LABEL)
				.bold(true)
				.build()
		);
		...
		memberButtonLabelWidgetMap.put(
			lang,
			builder
				.fieldMetadata(TemplateMembershipComponent.MEMBER_BUTTON_LABEL)
				.bold(true)
				.build()
		);
		...
		nonMemberButtonLabelWidgetMap.put(
			lang,
			builder
				.fieldMetadata(TemplateMembershipComponent.NON_MEMBER_BUTTON_LABEL)
				.bold(true)
				.build()
		);
	}
	...
	@Override
	public TemplateMembershipComponent getEntity() {
		return membershipComponent;
	}


	@Override
	public void setEntity(TemplateMembershipComponent membershipComponent) {
