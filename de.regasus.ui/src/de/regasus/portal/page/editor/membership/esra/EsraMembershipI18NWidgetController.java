...
public class EsraMembershipI18NWidgetController implements I18NWidgetController<EsraMembershipComponent>{


	// the entity
	private EsraMembershipComponent membershipComponent;
	...
	private Map<String, Text> sisterSocietyMemberButtonLabelWidgetMap = new HashMap<>();
	private Map<String, Text> sisterSocietyTraineeButtonLabelWidgetMap = new HashMap<>();


	public EsraMembershipI18NWidgetController() {
	}
	...
	public void createWidgets(Composite parent, ModifySupport modifySupport, String lang) {
		...
		membershipLabelWidgetMap.put(
			lang,
			builder
				.fieldMetadata(EsraMembershipComponent.MEMBERSHIP_LABEL)
				.bold(true)
				.build()
		);
		...
		memberButtonLabelWidgetMap.put(
			lang,
			builder
				.fieldMetadata(EsraMembershipComponent.MEMBER_BUTTON_LABEL)
				.bold(true)
				.build()
		);
		...
		nonMemberButtonLabelWidgetMap.put(
			lang,
			builder
				.fieldMetadata(EsraMembershipComponent.NON_MEMBER_BUTTON_LABEL)
				.bold(true)
				.build()
		);
		
		sisterSocietyMemberButtonLabelWidgetMap.put(
			lang,
			builder
				.fieldMetadata(EsraMembershipComponent.SISTER_SOCIETY_MEMBER_BUTTON_LABEL)
				.bold(true)
				.build()
		);
		
		sisterSocietyTraineeButtonLabelWidgetMap.put(
			lang,
			builder
				.fieldMetadata(EsraMembershipComponent.SISTER_SOCIETY_TRAINEE_BUTTON_LABEL)
				.bold(true)
				.build()
		);
	}
	...
	@Override
	public EsraMembershipComponent getEntity() {
		return membershipComponent;
	}


	@Override
	public void setEntity(EsraMembershipComponent membershipComponent) {
			...
			SWTHelper.syncExecDisplayThread(new Runnable() {
				...
				public void run() {
					try {
						...
						setLanguageStringToTextWidget(membershipComponent.getSisterSocietyMemberButtonLabel(), sisterSocietyMemberButtonLabelWidgetMap);
						setLanguageStringToTextWidget(membershipComponent.getSisterSocietyTraineeButtonLabel(), sisterSocietyTraineeButtonLabelWidgetMap);
					}
					catch (Exception e) {
	...
	public void syncEntityToWidgets() {
		if (membershipComponent != null) {
			...
			membershipComponent.setSisterSocietyMemberButtonLabel( buildLanguageString(sisterSocietyMemberButtonLabelWidgetMap) );
			membershipComponent.setSisterSocietyTraineeButtonLabel( buildLanguageString(sisterSocietyTraineeButtonLabelWidgetMap) );
		}
	}
