...
public class CreateGroupMemberTableComponentAction extends AbstractCreateComponentAction {

	private static final String ID = MethodHandles.lookup().lookupClass().getName();
	private static final String TEXT = I18N.PageEditor_CreateGroupMemberTableComponent;


	public CreateGroupMemberTableComponentAction(PageContentTreeComposite pageContentTreeComposite) {
	...
	protected Component buildComponent() {
		GroupMemberTableComponent component = GroupMemberTableComponent.build( getLanguageList() );
