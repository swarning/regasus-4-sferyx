...
public class PrintComponentComposite extends EntityComposite<PrintComponent> {
	...
	private I18NComposite<PrintComponent> i18nComposite;
	...
	public PrintComponentComposite(Composite parent, int style, Long portalPK)
	throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.PrintComponent.getString() );
	...
	private void buildI18NComposite(Composite parent) {
		i18nComposite = new I18NComposite<>(parent, SWT.BORDER, languageList, new PrintComponentCompositeI18NWidgetController());
		GridDataFactory
			.fillDefaults()
			.grab(true, false)
			.span(COL_COUNT, 1)
