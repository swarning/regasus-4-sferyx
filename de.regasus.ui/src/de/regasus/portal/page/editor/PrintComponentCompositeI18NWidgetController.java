...
public class PrintComponentCompositeI18NWidgetController implements I18NWidgetController<PrintComponent> {
	...
	public void createWidgets(Composite parent, ModifySupport modifySupport, String lang) {
		...
		buttonLabelWidgetMap.put(lang, builder.fieldMetadata(PrintComponent.BUTTON_LABEL).build());
	}
	...
	@Override
	public PrintComponent getEntity() {
		return component;
	}


	@Override
	public void setEntity(PrintComponent component) {
