...
public class SpeakerArrivalDepartureComponentComposite extends EntityComposite<SpeakerArrivalDepartureComponent> {
	...
	private I18NComposite<SpeakerArrivalDepartureComponent> i18nComposite;
	...
	public SpeakerArrivalDepartureComponentComposite(Composite parent, int style, Long portalPK) throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.SpeakerArrivalDepartureComponent.getString() );
		if (expertMode) {
	...
	private void buildLabel(Composite parent) {
		...
		i18nComposite = new I18NComposite(parent, SWT.BORDER, languageList, new SpeakerArrivalDepartureComponentCompositeI18NWidgetController());
