...
public class SpeakerRoomTypeComponentComposite extends EntityComposite<SpeakerRoomTypeComponent> {
	...
	private I18NComposite<SpeakerRoomTypeComponent> i18nComposite;
	...
	public SpeakerRoomTypeComponentComposite(Composite parent, int style, Long portalPK) throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		widgetBuilder.buildTypeLabel( PortalI18N.SpeakerRoomTypeComponent.getString() );
		if (expertMode) {
	...
	private void buildLabel(Composite parent) {
		...
		i18nComposite = new I18NComposite(parent, SWT.BORDER, languageList, new SpeakerRoomTypeComponentCompositeI18NWidgetController());
