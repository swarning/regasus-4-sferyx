...
public class ProgrammeBookingComponentLabelsComposite extends EntityComposite<ProgrammeBookingComponent> {
	...
	public ProgrammeBookingComponentLabelsComposite(Composite parent, int style, Long portalPK)
	throws Exception {
		super(
			parent,
			style,
	...
	protected void createWidgets(Composite parent) throws Exception {
		...
		descriptionLabel.setText(I18N.ProgrammeBookingComponentComposite_RenameLabelsDescription);

		i18nComposite = new I18NComposite<>(parent, SWT.BORDER, languageList, new ProgrammeBookingComponentLabelsI18NWidgetController());
