...
public class SendLetterOfInvitationComponentCompositeI18NWidgetController
	implements I18NWidgetController<SendLetterOfInvitationComponent> {

	// the entity
	private SendLetterOfInvitationComponent component;
	...
	public void createWidgets(Composite parent, ModifySupport modifySupport, String lang) {
		...
		buttonLabelWidgetMap.put(lang, builder.fieldMetadata(SendLetterOfInvitationComponent.BUTTON_LABEL).build());
	}
	...
	@Override
	public SendLetterOfInvitationComponent getEntity() {
		return component;
	}


	@Override
	public void setEntity(SendLetterOfInvitationComponent component) {
