 ...
 */
public class PortalTreeRoot extends DefaultTreeNode<Object> {
	...
	public PortalTreeRoot(TreeViewer treeViewer, ModifySupport modifySupport) {
	...
	private void initTree() {
		// load all Portals in advance to avoid multiple requests later
		try {
			portalModel.getPortalsByEvent(null);
		}
		catch (Exception e) {
