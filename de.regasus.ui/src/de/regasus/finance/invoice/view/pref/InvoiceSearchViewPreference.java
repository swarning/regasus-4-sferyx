package de.regasus.finance.invoice.view.pref;

import static de.regasus.finance.invoice.view.pref.InvoiceSearchViewPreferenceDefinition.*;
...
public class InvoiceSearchViewPreference extends AbstractPreference {

	private static final InvoiceSearchViewPreference INSTANCE = new InvoiceSearchViewPreference();
	...
	public static InvoiceSearchViewPreference getInstance() {
		return INSTANCE;
	}


	private InvoiceSearchViewPreference() {
	}
	...
	public void initialize() {
		PreferenceInitializerHelper.initializePreferences(getPreferenceStore(), InvoiceSearchViewPreferenceDefinition.class);
	}
