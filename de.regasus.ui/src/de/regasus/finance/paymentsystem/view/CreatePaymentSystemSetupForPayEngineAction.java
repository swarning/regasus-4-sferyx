...
public class CreatePaymentSystemSetupForPayEngineAction extends AbstractAction {
	...
	public CreatePaymentSystemSetupForPayEngineAction(IWorkbenchWindow window) {
		super();
		this.window = window;
		setId(ID);
		setText(FinanceI18N.PaymentSystemSetup_Action_Create_PayEngine_Text);
		setToolTipText(FinanceI18N.PaymentSystemSetup_Action_Create_PayEngine_ToolTip);
	...
	public void run() {
		...
		PaymentSystemSetupEditorInput editorInput = PaymentSystemSetupEditorInput.buildCreatePayEngineInstance();
		try {
