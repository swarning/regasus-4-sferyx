...
public class PayEngineSetupCombo extends PaymentSystemSetupCombo {


	public PayEngineSetupCombo(Composite parent, int style) throws Exception {
		super(parent, SWT.NONE);

		// avoid showing PaymentSystemSetup of other PaymentSystems but PayEngine
			...
			public String getText(Object element) {
				...
				if (paymentSystemSetup.getName() != null) {
    				...
    				if ( paymentSystemSetup.isTest() ) {
    					label.append(" (");
    					label.append( PayEngineSetup.TEST_ONLY.getString() );
    					label.append(")");
    				}
				}
	...
	protected Collection<PaymentSystemSetup> getModelData() throws Exception {
		Collection<PaymentSystemSetup> modelData = model.getPaymentSystemSetups(PaymentSystem.PAYENGINE);
		return modelData;
	}
